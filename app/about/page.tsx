...
export const metadata: Metadata = {
  title: '運営者情報 | 秘密の恋ノート',
  description: '秘密の恋ノートの運営者情報です。サイトの目的、運営方針をご確認ください。',
};
  ...
  return (
    <main className="legal-page">
      <article className="legal-content">
        ...
        <section className="legal-section">
          <h2>サイトの目的</h2>
          <p>「秘密の恋ノート」は、誰にも言えない恋の悩みを抱えるあなたに、信頼できる占い師やカウンセラーとの出会いをお手伝いするサイトです。</p>
          <p>7つの質問に答えるだけで、あなたの悩みに最も寄り添ってくれる相談先を無料で診断できます。</p>
        </section>
