...
export const metadata: Metadata = {
  title: 'お問い合わせ | 秘密の恋ノート',
  description: '秘密の恋ノートへのお問い合わせはこちらのフォームからお願いいたします。',
};
    ...
    <main className="legal-page">
      <article className="legal-content">
        ...
        <form
          ...
          method="POST"
        >
          <input type="hidden" name="_subject" value="【秘密の恋ノート】お問い合わせ" />
          <input type="hidden" name="_captcha" value="false" />
          <input type="hidden" name="_template" value="table" />

          <div className="form-group">
            <label htmlFor="contact-name">お名前（ニックネーム可）</label>
            <input type="text" id="contact-name" name="name" required placeholder="例：ゆき" />
          </div>
